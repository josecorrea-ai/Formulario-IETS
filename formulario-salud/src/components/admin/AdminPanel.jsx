...
export default function AdminPanel() {
  ...
  const documentosSubidos = users.filter(u => u.archivo).length;
      ...
      <div className="main-content">
        ...
        <div className="stats-row">
          ...
          <div className="stat-card">
            ...
            <div>
              <div className="stat-num">{users.length * 2}</div>
            ...
            <div className="table-body">
              {users.length === 0 ? (
                <div className="table-row">
                  <div className="td-cell" colSpan="8">No hay usuarios registrados</div>
                </div>
              ) : (
                users.map((u) => (
        ...
        <div className="users-cards">
          ...
          <div className="mobile-counter">
            ...
            <div className="mobile-counter-number">{users.length}</div>
          </div>
        </div>
      </div>
